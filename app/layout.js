...
export default function Welcome() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: '45%', left: '55%', width: 200, height: 200, borderRadius: '50%', background: 'radial-gradient(circle, rgba(99,102,241,0.08), transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontSize: 44,
          marginBottom: 18,
          boxShadow: '0 12px 40px rgba(55,48,163,0.3)',
          opacity: visible ? 1 : 0,
        ...
        <div style={{
          ...
          opacity: visible ? 1 : 0,
          transition: 'all 0.6s cubic-bezier(0.22, 1, 0.36, 1) 0.32s',
        }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontFamily: FONT,
                  transition: 'all 0.2s',
                  boxShadow: isSelected ? '0 4px 20px rgba(55,48,163,0.15)' : '0 2px 8px rgba(0,0,0,0.04)',
              ...
              >
                <div style={{
                  ...
                  background: isSelected ? 'rgba(55,48,163,0.1)' : '#F9FAFB',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  flexShrink: 0,
                }}>
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            fontFamily: FONT,
            boxShadow: pressed ? '0 4px 16px rgba(55,48,163,0.3)' : '0 10px 32px rgba(55,48,163,0.35)',
