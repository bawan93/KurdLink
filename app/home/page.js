...
const TX = {
  ...
  ku: {
    ...
    features: [
      { icon: '📄', title: 'ڕوونکردنەوەی نامە', desc: 'نامەیەکت لە هۆم ئۆفیس یان HMRC یان ئەنجومەن یان خاوەن خانووەکەت وەرگرتووە؟ وێنەیەک بگرە یان دەقەکە بنووسە و AI ی ئێمە لە چەند چرکەیەکدا بە زمانی خۆت ڕوونی دەکاتەوە.', cta: 'تاقی بکەرەوە', route: '/journey/document-explainer' },
