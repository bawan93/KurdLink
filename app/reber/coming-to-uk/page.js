  ...
  return (
    <svg viewBox="0 0 320 180" width="100%" style={{ display: 'block' }}>
      <defs>
        ...
        <filter id="cliffBlurS"><feGaussianBlur stdDeviation="1.5" /></filter>
        <filter id="softBlurS"><feGaussianBlur stdDeviation="0.8" /></filter>
      </defs>
      ...
      <g filter="url(#cliffBlurS)">
        <path d="M 140,108 L 140,82 C 145,60 155,55 165,58 C 172,60 175,65 178,62 C 183,56 190,50 200,52 C 210,54 212,60 218,58 C 226,54 232,48 242,50 C 252,52 255,58 262,56 C 270,53 278,46 288,48 C 298,50 305,56 315,54 L 320,54 L 320,108 Z" fill="url(#cliffS)" />
        <path d="M 140,82 C 145,60 155,55 165,58 C 172,60 175,65 178,62 C 183,56 190,50 200,52 C 210,54 212,60 218,58 C 226,54 232,48 242,50 C 252,52 255,58 262,56 C 270,53 278,46 288,48 C 298,50 305,56 315,54 L 320,54 L 320,58 C 305,60 298,54 288,52 C 278,50 270,57 262,60 C 255,62 252,56 242,54 C 232,52 226,58 218,62 C 212,64 210,58 200,56 C 190,54 183,60 178,66 C 175,69 172,64 165,62 C 155,59 145,64 140,86 Z" fill="url(#cliffGreenS)" opacity="0.7" />
      ...
      <g filter="url(#softBlurS)" opacity="0.85">
      ...
      <path d="M0,114 Q40,111 80,114 Q120,117 160,114 Q200,111 240,114 Q280,117 320,114" stroke="rgba(255,255,255,0.13)" strokeWidth="1.2" fill="none" />
      <path d="M0,126 Q50,123 100,126 Q150,129 200,126 Q250,123 300,126 L320,126" stroke="rgba(255,255,255,0.09)" strokeWidth="1" fill="none" />
      <path d="M0,140 Q80,137 160,140 Q240,143 320,140" stroke="rgba(255,255,255,0.07)" strokeWidth="1" fill="none" />
...
function LeaveToRemainIllustration() {
  return (
    <svg viewBox="0 0 320 180" width="100%" style={{ display: 'block' }}>
      <defs>
        <linearGradient id="bg2f" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#064E3B" />
          <stop offset="100%" stopColor="#065F46" />
        </linearGradient>
      </defs>
      <rect width="320" height="180" fill="url(#bg2f)" />
...
function CitizenshipIllustration() {
  return (
    <svg viewBox="0 0 320 180" width="100%" style={{ display: 'block' }}>
      <defs>
        <linearGradient id="bg3f" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#2E1065" />
          <stop offset="100%" stopColor="#4C1D95" />
        </linearGradient>
        <linearGradient id="passport3f" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#1D4ED8" />
          <stop offset="100%" stopColor="#1E3A8A" />
        </linearGradient>
      </defs>
      <rect width="320" height="180" fill="url(#bg3f)" />
      ...
      <g transform="translate(45, 28)">
        <rect x="0" y="0" width="95" height="125" rx="6" fill="url(#passport3f)" />
        <rect x="98" y="0" width="95" height="125" rx="6" fill="url(#passport3f)" />
...
const TX = {
  en: {
    ...
    cards: [
      { step: 'Stage 1', title: 'New to the UK', desc: 'Just arrived? This guide covers everything from your first steps on UK soil to getting your ARC card, housing support and free legal help.', stats: [{ val: '£49.18', label: 'Weekly support' }, { val: '100%', label: 'Free NHS' }], color: INDIGO, light: SOFT, cta: 'Read the guide', route: '/reber/new-to-uk' },
      { step: 'Stage 2', title: 'Leave to Remain', desc: 'Been granted refugee status? You have 28 days to act. Housing, benefits, work, bank accounts — this guide covers it all.', stats: [{ val: '28', label: 'Days to act' }, { val: '5yr', label: 'Leave to remain' }], color: '#059669', light: '#D1FAE5', cta: 'Read the guide', route: '/reber/leave-to-remain' },
      { step: 'Stage 3', title: 'British Citizenship', desc: 'The path to a British passport — settled status, indefinite leave to remain, the Life in the UK test and naturalisation.', stats: [{ val: '5yr', label: 'To settled status' }, { val: '£1,500', label: 'Approx. fee' }], color: '#7C3AED', light: '#EDE9FE', cta: 'Read the guide', route: '/reber/citizenship' },
    ],
  },
  ku: {
    label: 'گەشتەکەت', title: 'هاتنە UK',
    sub: 'هەموو ئەوەی پێویستتە بزانیت — لە کاتی گەیشتنەوە تا بوونە هاووڵاتیی بریتانی.',
    cards: [
      { step: 'قۆناغی ١', title: 'تازە گەیشتوویت بە UK', desc: 'تازە گەیشتوویت؟ ئەم ڕێنمایە هەموو شتێک لەخۆدەگرێت لە هەنگاوی یەکەم تا وەرگرتنی کارتی ARC و یارمەتیی یاسایی.', stats: [{ val: '٤٩.١٨£', label: 'پشتگیری هەفتانە' }, { val: '١٠٠٪', label: 'NHS بەخۆڕایی' }], color: INDIGO, light: SOFT, cta: 'ڕێنمایەکە بخوێنەوە', route: '/reber/new-to-uk' },
      { step: 'قۆناغی ٢', title: 'مۆڵەتی مانەوە', desc: 'مافت درا؟ ٢٨ ڕۆژت هەیە بۆ کردن. نیشتەجێبوون، یارمەتییەکان، کار، ئەژمارەی بانکی.', stats: [{ val: '٢٨', label: 'ڕۆژ بۆ کردن' }, { val: '٥ ساڵ', label: 'مۆڵەتی مانەوە' }], color: '#059669', light: '#D1FAE5', cta: 'ڕێنمایەکە بخوێنەوە', route: '/reber/leave-to-remain' },
      { step: 'قۆناغی ٣', title: 'هاووڵاتیی بریتانی', desc: 'ڕێگای بەدەستهێنانی پاسپۆرتی بریتانی — مافی نیشتەجێبوون، تاقیکردنەوەی ژیان لە UK.', stats: [{ val: '٥ ساڵ', label: 'بۆ مافی نیشتەجێبوون' }, { val: '١٥٠٠£', label: 'خەرجی تەخمینی' }], color: '#7C3AED', light: '#EDE9FE', cta: 'ڕێنمایەکە بخوێنەوە', route: '/reber/citizenship' },
    ],
  },
  fa: {
    label: 'سفر شما', title: 'آمدن به UK',
    sub: 'همه چیزی که باید بدانی — از لحظه ورود تا شهروندی بریتانیا.',
    cards: [
      { step: 'مرحله ۱', title: 'تازه رسیدی به UK', desc: 'تازه رسیدی؟ این راهنما همه چیز را از درخواست پناهندگی تا کارت ARC و کمک حقوقی پوشش می‌دهد.', stats: [{ val: '£49.18', label: 'کمک هفتگی' }, { val: '100%', label: 'NHS رایگان' }], color: INDIGO, light: SOFT, cta: 'راهنما را بخوان', route: '/reber/new-to-uk' },
      { step: 'مرحله ۲', title: 'اجازه اقامت', desc: 'وضعیت پناهندگی گرفتی؟ 28 روز فرصت داری. مسکن، مزایا، کار، حساب بانکی.', stats: [{ val: '28', label: 'روز برای اقدام' }, { val: '5سال', label: 'اجازه اقامت' }], color: '#059669', light: '#D1FAE5', cta: 'راهنما را بخوان', route: '/reber/leave-to-remain' },
      { step: 'مرحله ۳', title: 'شهروندی بریتانیا', desc: 'مسیر پاسپورت بریتانیایی — وضعیت مستقر، آزمون زندگی در UK و نحوه درخواست تابعیت.', stats: [{ val: '5سال', label: 'تا وضعیت مستقر' }, { val: '£1,500', label: 'هزینه تقریبی' }], color: '#7C3AED', light: '#EDE9FE', cta: 'راهنما را بخوان', route: '/reber/citizenship' },
    ],
  },
  ar: {
    label: 'رحلتك', title: 'القدوم إلى UK',
    sub: 'كل ما تحتاج معرفته — من لحظة وصولك حتى الحصول على الجنسية البريطانية.',
    cards: [
      { step: 'المرحلة ١', title: 'وصلت للتو إلى UK', desc: 'وصلت للتو؟ هذا الدليل يغطي كل شيء من طلب اللجوء إلى بطاقة ARC والمساعدة القانونية.', stats: [{ val: '£49.18', label: 'دعم أسبوعي' }, { val: '100%', label: 'NHS مجاني' }], color: INDIGO, light: SOFT, cta: 'اقرأ الدليل', route: '/reber/new-to-uk' },
      { step: 'المرحلة ٢', title: 'الإذن بالبقاء', desc: 'حصلت على وضع اللاجئ؟ لديك 28 يوماً للتصرف. السكن والمزايا والعمل والحسابات البنكية.', stats: [{ val: '28', label: 'يوماً للتصرف' }, { val: '5سنوات', label: 'إذن البقاء' }], color: '#059669', light: '#D1FAE5', cta: 'اقرأ الدليل', route: '/reber/leave-to-remain' },
      { step: 'المرحلة ٣', title: 'الجنسية البريطانية', desc: 'طريق جواز السفر البريطاني — الوضع المستقر واختبار الحياة في UK وكيفية التقدم للتجنيس.', stats: [{ val: '5سنوات', label: 'للوضع المستقر' }, { val: '£1,500', label: 'الرسوم التقريبية' }], color: '#7C3AED', light: '#EDE9FE', cta: 'اقرأ الدليل', route: '/reber/citizenship' },
    ],
  },
}

const ILLUSTRATIONS = [BoatIllustration, LeaveToRemainIllustration, CitizenshipIllustration]
      ...
      <div style={{ background: INDIGO_DARK, padding: '36px 24px 32px' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(129,140,248,0.2)', border: '1px solid rgba(129,140,248,0.3)', borderRadius: 20, padding: '4px 14px', marginBottom: 16 }}>
            <span style={{ fontSize: 11, fontWeight: 800, color: INDIGO_LIGHT, letterSpacing: 1.5 }}>{t.label}</span>
          </div>
          <h1 style={{ fontSize: 30, fontWeight: 900, color: '#fff', margin: '0 0 10px', letterSpacing: -0.5 }}>{t.title}</h1>
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)', margin: 0, lineHeight: 1.7, fontWeight: 500 }}>{t.sub}</p>
        </div>
      </div>
