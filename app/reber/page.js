...
const STAGE_CONTENT = {
    ...
    sections: [
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['مالی فووری بەشی ٩٨ دەدرێتت لەکاتی دەستپێکردنی پرۆسەی پەناکەت', 'ئەمە دەبێت خانووچە، هۆتێل، یان خانووی هاوبەش بێت — تۆ هەڵبژاردنت نییە', 'ئەمە دەکرێت لە هەر شوێنێکی UK بێت — نازانرێت هەمیشە نزیک خێزانەکەت بێت', 'مالەکەی پێشکەشکراو ڕەت مەکەوە — هەموو پشتگیرییەکەت دەچێت', 'دوای تۆمارکردنی کێسەکەت بۆ مالی بەشی ٩٥ دەگوێزرێیتەوە', '٤٩.١٨ پاوەند هەفتانە بۆ خواردن و پێداویستییەکانت دەگریت', 'ئەگەر مالەکە ناپارێزرا بوو یان ترسیدیت، فەوری بە کارمەندی کێسەکەت بڵێ'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['کار مەکە تاوەکو مۆڵەتی نووسراو بگریت', 'دەرچوونی UK مەکە — کێسەکەت داخرێتەوە', 'هیچ کاتێک قۆناغی ڕاپۆرتدانت لەدەستمەدە — ئەمە زۆر گرنگە', 'بەبێ ئاگادارکردنەوەی هۆم ئۆفیس ناونیشانت مەگۆڕیت', 'هیچ شتێک مەئیمزابکە کە تێناگەیتت — داوای وەرگێڕی بکە', 'پارێزەرێک بەکار مەهێنە کە تۆمارنەکراوە لە OISC — سەیری oisc.gov.uk بکە', 'بە هیچ کەسێک پارە مەدە کە دەڵێت دەتوانێت کێسەکەت خێراتر بکات'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['مافی نوێنەرایەتیی یاسایی بەخۆڕایی لە ڕێگەی Legal Aid', 'مافی وەرگێڕی بەخۆڕایی لە هەموو چاوپێکەوتنی فەرمی', 'مافی چارەسەری فووری بەخۆڕایی لە NHS، بێ گوێرەی مافی کۆچبەرییەکەت', 'مافی خوێندن بۆ منداڵەکانت لە تەمەنی ٥ تا ١٦ ساڵ', 'مافی ڕاپۆرتدانی ئازار، ئیستیسمار یان تاوان بە ئارامی', 'مافی مانەوە لە UK لەکاتی بڕیاردانی کێسەکەت', 'مافی تژیاوکاری ئەگەر داواکارییەکەت ڕەتکرایەوە'],
  ...
  waiting: {
    ...
    subtitle: { en: 'Your case is being decided. Know what you can and cannot do.', ku: 'کێسەکەت لە بڕیارداندایە. بزانە چیت دەکرێت و چیت ناکرێت.', fa: 'پرونده‌ات در حال بررسی است. بدان چه می‌توانی و چه نمی‌توانی انجام دهی.', ar: 'يجري البت في قضيتك. اعرف ما يمكنك وما لا يمكنك فعله.' },
    sections: [
      {
        ...
        points: {
          ...
          ku: ['پشتگیری پەنای بەشی ٩٥ — ٤٩.١٨ پاوەند هەفتانە بۆ هەر بەرپیاوێک', 'چارەسەری بەخۆڕاییی NHS بۆ تۆ و هەموو خێزانەکەت', 'قوتابخانەی بەخۆڕایی بۆ هەموو منداڵی ٥ تا ١٦ ساڵ', 'یارمەتیی یاسایی بەخۆڕایی بۆ کێسی پەناکەت', 'وەرگێڕی بەخۆڕایی لە هەموو چاوپێکەوتنی فەرمی', 'خواردنی بەخۆڕاییی قوتابخانە ئەگەر منداڵەکانت لە قوتابخانەن', 'مافی کردنەوەی ئەکاونتی بانکی بنچینەیی بە کارتی ARCت'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['ئەمە گرنگترین بەشی کێسەکەتە — بە وردی خۆت ئامادەبکەرەوە', 'ڕاستی تەواو بڵێ — ناڕاستەواز زیانی کێسەکەت دەدات', 'دەبێت پارێزەرت لەگەڵت بێت — هەرگیز تەنیا مەچو', 'هەر کاتێک کە گرانت بوو داوای پشوودانێک بکە — ئەمە مافی توە', 'دەتوانیت داوای چاوپێکەوتنگری هەمجنس بکەیت ئەگەر حەزت بێت', 'چاوپێکەوتنەکە تۆمار دەکرێت — هەموو شتێک دەڵێیت گرنگە', 'پارێزەرەکەت دەتوانێت هەر پرسیاری نادادپەروەرانەیەک ڕەت بکاتەوە', 'ئەگەر دوای چاوپێکەوتنەکە شتێکی گرنگت بیرهاتەوە — فەوری بە پارێزەرەکەت بڵێ'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['ترس، نیگەرانی و تەنیابوون هەستی ئاسایین — تاقم نیت', 'ماوەی چاوەڕوانی یەکێکە لە سەختترین کاتەکان — تەنیا نیت', 'بە کەسێک دەربارەیدا قسە بکە — خۆت لەخۆت گرتن شتەکان خراپتر دەکات', 'Samaritans: 116 123 — بەخۆڕایی، ٢٤/٧، هیچ پرسیارێک نادەن', 'MIND: 0300 123 3393 — پشتگیری تەندروستیی دەروونی', 'Shout: تێکستی بنێرە بۆ 85258 — پشتگیری لە کاتی کریز', 'دکتەرەکەت دەتوانێت بنێرێتت بۆ ڕاوێژکاری بەخۆڕایی — داوایی بکە', 'پەناهەندەکان ٥ جار زیاتر دوچاری PTSD دەبن — ئەمە ئەمرێکی ڕاستە'],
  ...
  granted: {
    ...
    subtitle: { en: 'Congratulations. Act quickly — you have 28 days before support stops.', ku: 'پیرۆزت بێت. خێرا ڕەفتار بکە — تەنها ٢٨ ڕۆژت هەیە پێش بڕیدانی پشتگیرییەکە.', fa: 'تبریک. سریع اقدام کن — ۲۸ روز قبل از قطع حمایت داری.', ar: 'تهانينا. تصرف بسرعة — لديك 28 يوماً قبل توقف الدعم.' },
    sections: [
      {
        ...
        points: {
          ...
          ku: ['تەنها ٢٨ ڕۆژت هەیە لە وەرگرتنی نامەی بڕیارەکەت پێش بڕیدانی پشتگیریی پەناکەت', 'ئەم ٢٨ ڕۆژانە بەکاربهێنە بۆ داواکاری Universal Credit، مال و ژمارەی NI ت', 'کارتی BRP ت لە ئۆفیسی پۆستی نووسراو لە نامەکەت وەربگرە — لە ناو ١٠ ڕۆژدا', 'فەوری لەگەڵ GP تۆمار بکە — پێویستت بە کارتی ARIES و BRP دەبێت', 'پەیوەندی بە شارداریی ناوچەکەت بکە دەربارەی مال — ئەمە لە هەفتەی یەکەمدا بکە', 'ئەکاونتی بانکی بکەرەوە — Monzo و Starling BRP قبوول دەکەن و ئاسانترن', 'فەوری داواکاری ژمارەی بیمەی نیشتمانیت بکە لە gov.uk'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['Monzo و Starling ئاسانترن — لە ڕێگەی ئەپ لە چەند خولەکدا بکەرەوە', 'پێویستتە بە: کارتی BRP، ناونیشانی UK، ژمارەی تەلەفۆن، ئیمەیڵ', 'Halifax و Lloyds هەروەها BRP قبوول دەکەن بۆ ئەکاونتی لە لقدا', 'لە کۆمپانیاکانی قەرزی خێرا دووربکەوەرەوە — سوودی زۆری گران وەردەگرن', 'Universal Credit ت ڕاستەوخۆ دەدرێتە ئەکاونتی بانکیت', 'دەتوانیت پارە بنێریت بۆ دەرەوەی وڵات بە Wise یان Remitly — ئاسانتر و ئاڵۆزترن لە بانکەکان', 'هەرگیز زانیاری ئەکاونتەکەت، PIN یان پاسووردی بانکی ئۆنلاینت بە هیچ کەسێک مەدە'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['داواکاری مۆڵەتی موقەتی بکە لە gov.uk/apply-first-provisional-driving-licence', 'تێچوو: ٣٤ پاوەند ئۆنلاین — پێویستتە بە BRP، وێنەی پاسپۆرت، ناونیشانی UK', 'تێستی تیۆری: ٢٣ پاوەند — کاتی جێگیر بکە لە gov.uk/book-theory-test', 'تێستی پراکتیکی: ٦٢ پاوەند — کاتی جێگیر بکە لە gov.uk/book-driving-test', 'مامۆستای شۆفێری کوردی لە KurdLink بدۆزەرەوە', 'ئەگەر پێشتر لە وڵاتێکی تر مۆڵەتت هەبوو، دەکرێت بیگۆڕیت', 'زۆربەی خەڵک ٣٠ تا ٥٠ کاتژمێر درس وەردەگرن پێش دەرچوون'],
  ...
  refused: {
    ...
    subtitle: { en: "Don't panic. You have rights and options. Act within 14 days.", ku: 'نیگەران مەبە. مافت و بژاردەت هەیە. لە ناو ١٤ ڕۆژدا ڕەفتار بکە.', fa: 'نگران نباش. حقوق و گزینه‌هایی داری. ظرف ۱۴ روز اقدام کن.', ar: 'لا تذعر. لديك حقوق وخيارات. تصرف خلال 14 يوماً.' },
    sections: [
      {
        ...
        points: {
          ...
          ku: ['نامەی ڕەتکردنەوەکە بە وردی بخوێنەوە — هەموو هۆکارێک تێبگە', 'ئەمڕۆ پەیوەندی بە پارێزەرەکەت بکە — تەنانەت یەک ڕۆژ چاوەڕوان مەبە', 'پارێزەرت نییە؟ فەوری پەیوەندی بکە بە Legal Aid: 0300 200 2020', 'دەتوانیت لە UK بمێنیتەوە لەکاتی گوێگرتن لە تژیاوکارییەکەت', 'هەموو کاتێک چوونە ڕاپۆرتدانت بکە — لەدەستدانی یەکێک دەکرێت کێشە بخوێنێتەوە', 'مال و پشتگیری داراییت دەبێت بەردەوام بێت لەکاتی تژیاوکاری', 'هەموو شتێک بنووسە کە یادت دێتەوە — بەلگەی نوێ دەتوانرێت لە تژیاوکارییەکەدا زیادبکرێت'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['ئەنجومەنی پەناهەندەکان: 020 7346 6700 — ڕاوێژ و پشتگیری بەخۆڕایی', 'Asylum Aid: 020 7354 9631 — نوێنەرایەتیی یاسایی بەخۆڕایی', 'Migrant Help: 0808 8010 503 — هێڵی یارمەتیی بەخۆڕایی ٢٤/٧', 'UNHCR UK: unhcr.org/uk — ئەژانسی پەناهەندەکانی نەتەوەیەکگرتووەکان', 'Citizens Advice: 0800 144 8848 — ڕاوێژی گشتی بەخۆڕایی', 'Shelter: 0808 800 4444 — ئەگەر مەترسی بێ ماوییت هەیە', 'Medical Justice: ئەگەر دەستگیرکراوت یان ئەزموونی ئازاری هەیە'],
    ...
    sections: [
      {
        ...
        points: {
          ...
          ku: ['دەتوانیت لە هەرجۆر کارێکدا لە UK کاربکەیت', 'کەمترین مووچە (٢٠٢٤): ١١.٤٤ پاوەند/کاتژمێر بۆ گەورەسالانی ژوورەوەی ٢١ ساڵ', 'کارفەرمات ناتوانێت بەهۆی پێشینەکەتەوە کەمتر پارەت بدات', 'بیمەی نیشتمانی و باجی داهات وەک هەموو کەسێک دەدەیت', 'هەموو پارەدانەکانت بیگرەوە — پێویستیان بۆ داواکاری ILR دەبێت', 'ئیستیسمار بەبێ ناسراوی ڕاپۆرت بکە: 0800 028 3838', 'دەتوانیت کاروباری خۆت دامەزرێنیت — KurdLink دەتوانێت یارمەتیت بدات لیستی بکەیت'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['وەک پەناهەندە دەتوانیت داواکاری بکەیت بۆ هێنانی هاوسەرت و منداڵانی ژێر ١٨ ساڵ', 'لە ناو ٣ مانگی وەرگرتنی مافەکەت داواکاری بکە — پرۆسەکە ئاسانتر دەبێت', 'تێچووی داواکارییەکە: لە ٣٨٨ پاوەند بۆ هەر کەسێک', 'پەیوەندی بکە بە ئەنجومەنی پەناهەندەکان بۆ یارمەتیی بەخۆڕایی: 020 7346 6700', 'پرۆسەکە زۆرجار ٦ تا ١٢ مانگ دەخایەنێت', 'ئەندامانی خێزانەکەت هەروەها مافی پەناهەندەیی وەردەگرن', 'دەتوانن کاربکەن، بخوێنن و دەستبگەن بە NHS دوای گەیشتنیان'],
  ...
  citizen: {
    ...
    subtitle: { en: 'From refugee to British citizen — the full journey.', ku: 'لە پەناهەندە تا هاووڵاتیی بەریتانی — تەواوی ڕێگاکە.', fa: 'از پناهنده تا شهروند بریتانیایی — کل سفر.', ar: 'من لاجئ إلى مواطن بريطاني — الرحلة الكاملة.' },
    sections: [
      {
        ...
        points: {
          ...
          ku: ['ILR = مۆڵەتی مانەوەی بەبێ کۆتایی — مۆڵەتی هەمیشەیی بۆ نیشتەجێبوون لە UK', 'دوای ٥ ساڵی نیشتەجێبوونی یاسایی واجب دەبیت', 'تێچووی داواکارییەکە: ٢،٨٨٥ پاوەند — زووتر دەستبکە بە پاشەکەوتکردن', 'پێویستە پێش ئەوە تێستی ژیانی UK ت تێپەڕ بکەیت', 'پێویستە ئاستی B1 لە زمانی ئینگلیزی پێشکەش بکەیت', 'تۆمەری تاوان کاریگەری دەبێت لەسەر واجببوونتدا', 'ئۆنلاین داواکاری بکە لە gov.uk/indefinite-leave-to-remain'],
      ...
      },
      {
        ...
        points: {
          ...
          ku: ['٢٤ پرسیار، ٤٥ خولەک، دەبێت ٧٥٪ یان زیاتر بگریت بۆ تێپەڕین', '٥٠ پاوەند بۆ هەر هەوڵدان — سنوری نییە بۆ چەندجار دەتوانیت بیدەیت', 'مێژوو، بەهاکان، کولتوور، یاسا و حکومەتی بەریتانیا داپۆشراوە', 'کتێبی خوێندنی فەرمی بەردەستە بۆ ١٤.٩٩ پاوەند لە ئەمازۆن', 'تێستی پراکتیسی بەخۆڕایی لە lifeintheuktest.gov.uk', 'زۆربەی کتێبخانەکان پۆلی خوێندنی بەخۆڕایی پێشکەش دەکەن — لە کتێبخانەی ناوچەکەتدا بیپرسە', 'زۆربەی خەڵک لە ١ تا ٣ هەوڵدان تێدەپەڕن بە ئامادەکاریی باش'],
...
const INFO_SECTIONS = [
  {
    ...
    points: {
      ...
      ku: ['لەگەڵ GP تۆمار بکە لە nhs.uk/find-a-gp — پێویستت بە ناسنامە یان بەلگەی کۆچبەری نییە', 'بەهۆی مافی کۆچبەریتەوە ناتوانرێت ڕەتی چارەسەری NHS بکرێت', 'هەموو کاتێک داوای وەرگێڕی کوردی/سۆرانی/فارسی/عەرەبی بکە — بەخۆڕاییە و مافی توە', '999 = تەنها کریزی گیان | 111 = یارمەتیی تەندروستی، نەک کریز | GP = چارەسەری ئاسایی', 'A&E کراوەیە ٢٤/٧ بۆ برینی گران و نەخۆشیی گران', 'چارەسەری دەندانی بەخۆڕاییە ئەگەر لەسەر پشتگیری پەنا یان Universal Credit بیت', 'چارەسەری دووگیانی بەخۆڕاییە — دەربارەی دەوروبەرت بە مامەوانەکەت بڵێ', 'پشتگیری تەندروستیی دەروونی بەردەستە — لە GP ت داواکارییەکە بکە', 'کلینیکەکانی تەندروستیی جنسی بەخۆڕایین و تەواو نهێنین'],
  ...
  },
  {
    ...
    points: {
      ...
      ku: ['هەموو منداڵی ٥ تا ١٦ ساڵ بە یاسا دەبێت لە قوتابخانە بن — ئەمە بۆ پەناهەندەکانیش جێبەجێ دەبێت', 'پەیوەندی بە شارداریی ناوچەکەت بکە بۆ دۆزینەوەی شوێنی قوتابخانە — دەبێت دووبکەنەوەت', 'قوتابخانەکان ناتوانن منداڵێک ڕەت بکەنەوە بەهۆی مافی کۆچبەریەوە', 'پشتگیری EAL (ئینگلیزی وەک زمانی دووەم) لە زۆربەی قوتابخانەکان بەردەستە', 'خواردنی بەخۆڕاییی قوتابخانە بەردەستە ئەگەر پشتگیری پەنا یان Universal Credit وەردەگریت', 'یارمەتیی یونیفۆرم بەردەستە — لە قوتابخانەکە بیپرسە', 'پۆلەکانی ESOL (ئینگلیزی بۆ قسەکەرانی زمانەکانی تر) بەخۆڕایین — لە esol.org.uk بیدۆزەرەوە', 'گەورەسالان دەتوانن بەخۆڕایی لە کۆلێجدا خوێندن بخوێنن — لە کۆلێجی ناوچەکەتدا بیپرسە', 'زانکۆش بوونی هەیە — بۆ ڕێنمایی دەربارەی خەرجی و دارایی سەری UKCISA.org.uk بچێک بکە'],
  ...
  },
  {
    ...
    points: {
      ...
      ku: ['تاوەکو تژیاوکارییەکەت چالاک بێت ناتوانرێت دەربکرێیت لە UK', 'هەموو کاتێک مافت هەیە بۆ وەرگێڕی بەخۆڕایی — داوایی بکە', 'پۆلیس ناتوانێت تەنها بەهۆی ڕەگ، ئایین یان دیمەنتەوە بیوەستێنێتت', 'کارفەرمات دەبێت کەمترین مووچە پێبدات بێ گوێرەی مافی کۆچبەرییەکەت', 'خاوەن مالەکە ناتوانێت بەبێ بڕیاری دادگا دەربکاتت', 'قوربانیانی ئازاری ناوخانە دەتوانن دەربچن و هێشتا پشتگیری بگرن', 'ئاگادارکردنەوەی ئیستیسمار کێسی پەناکەت خراپ ناکات', 'دەتوانیت تاوانی ڕقکەوتنەوە بە ئارامی ڕاپۆرت بکەیت: 0800 138 1625', 'منداڵان ناتوانرێن وەرگێڕ بن لە چاوپێکەوتنی تەندروستی یان یاسایی', 'مافت هەیە بەتەنها دکتەرت ببینیت بەبێ ئەوەی کارمەندی کێسەکەت لەگەڵت بێت'],
  ...
  },
  {
    ...
    points: {
      ...
      ku: ['Universal Credit: یارمەتیی سەرەکی بۆ گەورەسالانی تەمەنی کارکردن — داواکاری بکە لە gov.uk/universal-credit', 'یارمەتیی منداڵ: ٢٥.٦٠ پاوەند/هەفتانە بۆ منداڵی یەکەم، ١٦.٩٥ بۆ هەر منداڵێکی تر', 'خواردنی بەخۆڕاییی قوتابخانە بۆ منداڵان ئەگەر داهاتی کەم بیت', 'کەمکردنەوەی باجی شار — لە شارداریی ناوچەکەتدا داواکاری بکە', 'کوپۆنەکانی Healthy Start ئەگەر دووگیانت یان منداڵی ژێر ٤ ساڵت هەیە', 'داشکاندنی مالی گەرم: ١٥٠ پاوەند کەمکردن لە ئەژمارەی وزەت ئەگەر ژمارەیەک یارمەتیت وەردەگریت', 'نووسخەی بەخۆڕایی ئەگەر Universal Credit یان پشتگیری داهاتی وەردەگریت', 'پرۆگرامی داهاتی کەمی NHS (فۆرمی HC1) بۆ یارمەتی لە تێچووی دەندان و چاو', 'Citizens Advice دەتوانێت سەیر بکات ئایا هەموو شتێک داواکاری دەکەیت کە مافت پێیەتی: 0800 144 8848'],
