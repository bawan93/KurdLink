...
function CategoryBadge({ category, t, lang }) {
  const isRtlLang = lang === 'ku' || lang === 'fa' || lang === 'ar'
  const isImmigration = category === 'immigration'
  return (
    <span style={{
...
function NewsCard({ article, t, lang }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8, flexDirection: isRtl ? 'row-reverse' : 'row' }}>
        <CategoryBadge category={article.category} t={t} lang={lang} />
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '16px 16px 0' }}>
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p style={{ color: '#9CA3AF', fontFamily: FONT, fontSize: 14, margin: 0, textAlign: 'center' }}>
              {t.loading}
            </p>
        ...
        {error && !loading && (
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p style={{ color: '#6B7280', fontFamily: FONT, fontSize: 14, marginBottom: 20, textAlign: 'center' }}>
              {t.error}
            </p>
            <button
              onClick={loadNews}
