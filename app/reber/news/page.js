  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: isRtl ? 'flex-start' : 'flex-end' }}>
        <span style={{ fontSize: 11, color: '#9CA3AF', fontFamily: FONT, fontWeight: 600 }}>
          {timeAgo(article.date)}
        </span>
      </div>
      <h3 style={{ margin: 0, fontSize: 15, fontWeight: 800, color: INDIGO_DARK, fontFamily: FONT, lineHeight: 1.4, textAlign: align }}>
        {article.title}
      </h3>
      <p style={{ margin: 0, fontSize: 13, color: '#6B7280', fontFamily: FONT, lineHeight: 1.6, textAlign: align }}>
        {article.summary}
      </p>
    ...
    <div style={{ minHeight: '100vh', background: BG, fontFamily: FONT, paddingBottom: 80 }}>
      <div style={{
        ...
        <div style={{ maxWidth: 480, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: '#fff', fontSize: 26, fontWeight: 900, margin: '0 0 10px', lineHeight: 1.3, textAlign: align }}>
            {t.heroTitle}
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 14, margin: 0, lineHeight: 1.6, textAlign: align }}>
            {t.heroSub}
          </p>
        </div>
      </div>
