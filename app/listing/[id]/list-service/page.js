...
const TX = {
  en: {
    heroTitle: 'List a Service',
    heroSub: 'Offer your skills to the Komek community',
    serviceName: 'Service Name',
    serviceNamePh: 'e.g. Plumber, Driving Instructor, Accountant',
    description: 'Description',
    descPh: 'Describe your service, experience, and what makes you stand out...',
    location: 'Location',
    ...
    contactPh: 'How should people get in touch?',
    submit: 'List My Service',
    submitting: 'Listing...',
    success: 'Service listed! It will appear once approved.',
    required: 'Please fill in all fields.',
  },
  ku: {
    heroTitle: 'خزمەتگوزاری تۆمار بکە',
    heroSub: 'شارەزاییەکانت پێشکەش بکە بە کۆمەڵگای کۆمەک',
    serviceName: 'ناوی خزمەتگوزاری',
    serviceNamePh: 'بۆ نموونە: بلامبەر، مامۆستای شوفێری، ژمێریار',
    description: 'وەصف',
    descPh: 'خزمەتگوزاریەکەت، ئەزموونەکەت، و تایبەتمەندیەکانت وەسف بکە...',
    location: 'شوێن',
    locationPh: 'بۆ نموونە: لەندەن، بێرمینگهام، یان سەرتاسەری بریتانیا',
    price: 'نرخ',
    pricePh: 'بۆ نموونە: ٥٠ پاوند/کاتژمێر، لە ٢٠٠ پاوند',
    contact: 'پەیوەندی (تەلەفۆن یان ئیمەیل)',
    contactPh: 'چۆن پەیوەندیت پێ بکەن؟',
    submit: 'خزمەتگوزاری تۆمار بکە',
    submitting: 'دەنێردرێت...',
    success: 'خزمەتگوزاری تۆمار کرا! دوای پەسەندکردن دەردەکەوێت.',
    required: 'تکایە هەموو خانەکان پڕ بکەرەوە.',
  },
  fa: {
    heroTitle: 'خدمت ثبت کن',
    heroSub: 'مهارت‌هایت را به جامعه کومک ارائه بده',
    serviceName: 'نام خدمت',
    serviceNamePh: 'مثلاً: لوله‌کش، مربی رانندگی، حسابدار',
    description: 'توضیحات',
    descPh: 'خدمت، تجربه و مزیت‌هایت را توضیح بده...',
    location: 'موقعیت',
    locationPh: 'مثلاً: لندن، بیرمنگام یا سراسر بریتانیا',
    price: 'قیمت',
    pricePh: 'مثلاً: ۵۰ پوند/ساعت، از ۲۰۰ پوند',
    contact: 'تماس (تلفن یا ایمیل)',
    contactPh: 'چطور تماس بگیرند؟',
    submit: 'ثبت خدمت',
    submitting: 'در حال ثبت...',
    success: 'خدمت ثبت شد! پس از تأیید نمایش داده می‌شود.',
    required: 'لطفاً همه فیلدها را پر کنید.',
  },
  ar: {
    heroTitle: 'أدرج خدمة',
    heroSub: 'قدّم مهاراتك لمجتمع كومك',
    serviceName: 'اسم الخدمة',
    serviceNamePh: 'مثال: سباك، مدرب قيادة، محاسب',
    description: 'الوصف',
    descPh: 'صف خدمتك وخبرتك وما يميزك...',
    location: 'الموقع',
    locationPh: 'مثال: لندن، برمنغهام، أو على مستوى المملكة',
    price: 'السعر',
    pricePh: 'مثال: £50/ساعة، من £200',
    contact: 'التواصل (هاتف أو بريد إلكتروني)',
    contactPh: 'كيف يتواصل معك الناس؟',
    submit: 'إدراج الخدمة',
    submitting: 'جارٍ الإدراج...',
    success: 'تم إدراج الخدمة! ستظهر بعد الموافقة.',
...
export default function ListServicePage() {
  ...
  async function handleSubmit() {
    ...
    if (!serviceName || !description || !location || !price || !contact) {
      setError(t.required)
      return
    }
    setError('')
    ...
    const { error: sbError } = await supabase.from('listings').insert({
      ...
      status: 'pending',
      user_id: userId,
      data: { serviceName, description, location, price, contact },
    })
    setSubmitting(false)
