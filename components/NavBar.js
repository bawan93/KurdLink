...
const GUIDE_ITEMS = {
  en: [
    { label: 'Coming to the UK',       sub: 'Your step by step journey guide',     icon: '🇬🇧', route: '/reber/coming-to-uk' },
  ...
  ku: [
    { label: 'هاتنە UK',              sub: 'ڕێنمای گەشتەکەت هەنگاو بە هەنگاو',   icon: '🇬🇧', route: '/reber/coming-to-uk' },
  ...
  fa: [
    { label: 'آمدن به UK',             sub: 'راهنمای سفر گام به گام',              icon: '🇬🇧', route: '/reber/coming-to-uk' },
  ...
  ar: [
    { label: 'القدوم إلى UK',          sub: 'دليل رحلتك خطوة بخطوة',              icon: '🇬🇧', route: '/reber/coming-to-uk' },
